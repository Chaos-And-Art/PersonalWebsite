...
export class DashboardComponent implements OnInit {
  ...
  constructor(private themeService: ThemingService, private router: Router, private elementRef: ElementRef) {
  ...
  ngOnInit(): void {
    ...
    this.particlesOptions = particleConfig.particleOptionsArrayDashboard[0];
  }
  ...
  ngAfterViewInit() {
    ...
    this.elementRef.nativeElement.querySelector('.mdc-switch__icon--on').firstChild.setAttribute('d', moon);
    this.elementRef.nativeElement.querySelector('.mdc-switch__icon--off').firstChild.setAttribute('d', sun);
  }
